def train_go1(headless=True):
    ...
    Cfg.commands.num_commands = 12    #15    changed
    Cfg.env.observe_two_prev_actions = True
    Cfg.env.observe_yaw = False
    Cfg.env.num_observations = 55 + Cfg.commands.num_commands
    ...
    Cfg.rewards.base_height_target = 0.3   #目标身体高度
    ...
    Cfg.commands.body_height_cmd = [-0.15, 0.1]
    ...
    Cfg.commands.limit_vel_x = [-3.0, 3.0]
    Cfg.commands.limit_vel_y = [-0.6, 0.6]
    Cfg.commands.limit_vel_yaw = [-3.0, 3.0]
    Cfg.commands.limit_body_height = [-0.15, 0.1]
